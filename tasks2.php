...
$user_projects = R::find( 'projects', ' user_id = ? ',  [$_SESSION['id']]);
...
<body>
                ...
                <div class="modal-body">
                    <form id="contactForm" action="./services/addTask" method="post">
                        <div class="form-group">
                            ...
                            if (empty($user_projects)){
                                ...
                                foreach ($user_projects as $project) {
                                    echo '<option>'.$project['pr_name'].'</option>';
                                }
                                echo '</select>
                                <p>Default:Other projects </p>';
                            }
                            ?>
                        ...
                        <div class="form-group">
                            ...
                            <input id="tname" class="form-control" name="tname" required type="text" placeholder="Task name" value="" required>
                        </div>
                        <div class="form-group">
                ...
                <div class="modal-body">
                    <form id="contactForm" action="./services/addClient" method="post">
                        <div class="form-group">
                            ...
                            <input id="clientName" class="form-control" name="clientName" type="text" placeholder="Client name" value="" required>
                        </div>
                        <div class="form-group">
                            <label for="email">Client e-mail:</label>
                            <textarea id="email" class="form-control" name="email" rows="4" placeholder="Optional" value=""></textarea>
                        </div>
                        <div class="form-group">
                            <label for="phone">Client phone number:</label>
                            <textarea id="phone" class="form-control" name="phone" rows="4" placeholder="Optional" value=""></textarea>
                        </div>
                        <button id="button" class="btn btn-success btn-block" name="submit" type="submit">Add new client!</button>
                    </form>
                </div>
            </div>
        </div>
                ...
                <div class="modal-body">
                    <form id="contactForm" action="./services/addProject" method="post">
                        <div class="form-group">
                            ...
                            <input id="prname" class="form-control" name="prname" type="text" placeholder="Project name" value="" required>
                        </div>
                        <div class="form-group">
                            <label for="prdesc">Project description:</label>
                            <textarea id="prdesc" class="form-control" name="prdesc" rows="4" placeholder="Optional" value=""></textarea>
                        </div>
                        <div class="form-group">
                            ...
                            ?>
                            <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#addClient" data-dismiss="modal">Add new client!</button>
                        </div>
                        <button id="button" class="btn btn-success btn-block" name="submit" type="submit">Add new project!</button>
                    </form>
                </div>
            </div>
        </div>
    ...
    if(empty($user_projects)) echo "No projects were assigned.";
        ...
        foreach ($user_projects as $project) {
            $user_tasks = R::find( 'tasks', ' user_id = ? AND pr_name = ? ',  [$_SESSION['id'], $project["pr_name"]]);
                echo '
                <div class="container">
                <details open>
